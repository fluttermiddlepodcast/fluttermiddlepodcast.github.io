...
categories: post
description: Дополнительные советы по ускорению build_runner в Flutter, параллельная генерация кода, настройка для крупных проектов, оптимизация времени сборки
---
