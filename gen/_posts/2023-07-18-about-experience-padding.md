...
categories: post
description: Размышления о накрутке опыта в резюме разработчика, фильтрах рекрутеров и том, что опыт работы не всегда показывает реальный уровень программиста
---
