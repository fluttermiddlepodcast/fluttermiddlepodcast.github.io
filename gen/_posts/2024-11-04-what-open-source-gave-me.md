...
categories: post
description: Опыт разработки и поддержки open source приложения, чему учит собственный проект с открытым кодом, взаимодействие с сообществом, польза для карьеры
---
