...
categories: post
description: Использование AI для подготовки подкастов, автоматизация работы с текстом, ChatGPT и другие инструменты для создания контента, редактирование с помощью нейросетей
---
