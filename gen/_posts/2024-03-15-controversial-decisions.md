...
categories: post
description: Почему разработчики создают излишне сложные архитектурные решения, проблема самописных библиотек, важность баланса между абстракциями и простотой в небольших проектах
---
