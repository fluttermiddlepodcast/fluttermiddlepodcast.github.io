...
categories: post
description: Критический взгляд на компании с культурой "вторая семья", манипуляции руководства, переработки и токсичные практики под видом заботы о сотрудниках
---
