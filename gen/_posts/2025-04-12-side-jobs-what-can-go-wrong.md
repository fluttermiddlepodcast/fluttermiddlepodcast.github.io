...
categories: post
description: Риски подработок для разработчиков, конфликт интересов с основной работой, проблемы с NDA, выгорание от дополнительных проектов, как правильно браться за фриланс
---
